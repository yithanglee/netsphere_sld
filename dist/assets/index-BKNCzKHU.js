...
" class="text-center 
        ...
        </div>`,$("td:eq("+i+")",e).html(d)}catch{}})},progress(e,t,s){var a=s.columns.filter((n,l)=>n.showProgress==!0);a.forEach((n,l)=>{var i=0;i=s.columns.findIndex((x,f)=>x.data==n.data);try{var d=t[n.data],o=n.progress,u=[],h=1/o.length*100,v=o.findIndex((x,f)=>x==d);o.forEach((x,f)=>{if(v>=f)var g='<div class="progress-bar bg-warning " role="progressbar" style="width: '+h+`%;" ></div>
        ...
        bg-primary d-flex align-items-center justify-content-center text-white">
              ...
              </div>`;v.push(w)});var x=document.createElement("div");x.className=" card p-2",x.innerHTML=v.join(""),$(o).prepend(x)}})}this.load=function(i,d){i!=null?(this.tableSelector="#"+i,this.makeid={id:i,dom:d},r.Page.createTable(i,d)):r.Page.createTable(this.makeid.id,this.makeid.dom),r.populateTable(this),this.table.on("draw",()=>{var o=`
          <li>
      ...
      `),$("#ptitle").html(e.name),$("[mproduct-id='"+e.id+"']")[0].onclick=t})},merchantProducts(){let e;function t(){return phxApp.user==null?"b.is_approved=true|b.country_id="+r.chosen_country_id_.id:"b.is_approved=true|b.country_id="+phxApp.user.country_id}function s(i,d,o,u,h){var v=`
                    ...
                    `;return v}function a(i){var d="v2";return i=="Thailand"&&(d="th"),i=="Vietnam"&&(d="vn"),i=="China"&&(d="cn"),d}var n=[];if(r.countries_.forEach((i,d)=>{n.push(`
              ...
              `)}),r.chosen_country_id_==null&&pageParams.share_code==null&&(r.modal({selector:"#mySubModal",content:`
                ...
                `).then(()=>{var u=null,h="mproducts",v=new U({onDrawFn:()=>{$(".spinner-border.loading").parent().remove(),$(".loading").removeClass("d-none"),setTimeout(()=>{$("[mproduct-id]").each((x,f)=>{f.onclick=()=>{i(f)}}),S.formatDate()},1200)},xcard:x=>{var f=x,g="",w="/images/placeholder.png",k=`onclick="phxApp.navigateTo('/merchant_products/`+f.id+"/"+f.name+`')"`;if($(o).attr("direct")!=null&&(k="",g='<div class="btn btn-outline-primary mt-4" mproduct-id="'+f.id+'">Add</div>'),f.img_url!=null)try{w=f.img_url}catch{w="/images/placeholder.png"}var P=f.merchant;return s(k,w,P,f,g)},data:{sorts:[[1,"asc"]],additional_join_statements:[{merchant:"merchant"}],additional_search_queries:[t()],preloads:["merchant"],grid_class:"col-4 col-lg-3",dom:`
    ...
    `;try{s=t.user.shipping,console.log("shippnig..."),console.info(s),payment=e.payment}catch(b){console.error(b)}var v={};if(e.payment!=null){e.payment.payment_url!=null&&(h=`
               ...
               <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <span class="text-primary "><span class="">`+payment.payment_method.split("_").map((b,C)=>S.capitalize(b)).join(" ")+`</span></span>
                </div>
                <div class="d-flex justify-content-between align-items-center">
      ...
      `);try{if(console.info(e.payment),e.payment.webhook_details!=null){e.payment.webhook_details.split("|").map((b,C)=>{data=b.split(": ");var I=data[0].replace(" ","_");console.log(I),v[I]=parseFloat(data[1])}),console.info(v),drp_amount=0;var x="DRP";o&&(x="Merchant Point"),(v.drp_paid!=null||v.mp_paid!=null)&&(drp_amount=v.drp_paid,o&&(drp_amount=v.mp_paid)),v.pp_paid!=null&&(n=0);var f=n-drp_amount,g=l+i-drp_amount-(v.rp_paid||0),w=` <div class="d-flex justify-content-between align-items-center">
                  <span class="fw-bold text-secondary">Eligible Rank</span>
                  <span class="text-info "><span class="format-integer">`+d+`</span></span>
                </div>`;o&&(w="",f=n,g=l+i),h=`
               ...
               <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <span class=" ">RP <span class="format-float">`+g+` </span></span>
                </div>
    ...
    `:s={phone:null,fullname:null},e.pick_up_point!=null&&(k=`           <span class="text-secondary">Pick Up Point: </span>
      ...
      `),$(".approve-sale").click(function(){var b=$(this).attr("aria-id");r.modal({selector:"#mySubModal",content:`<div>
          ...
          `)}),$(".change-address").click(()=>{$("[name='user[pick_up_point_id]']").val(""),$(".shipping-form").removeClass("d-none"),$(".self-pickup-form").addClass("d-none"),$("[name='user[shipping][state]']").attr("required"),console.log("attr add"),r.modal({autoClose:!1,selector:"#mySubModal",content:`
            ...
            `)}});var u=!1;try{$("input[name='user[instalment]']").val()!=null&&(u=!0)}catch(y){console.error(y)}try{$("input[name='user[stockist_user_id]']").val()!=null&&(l=0)}catch(y){console.error(y)}u&&(l=0),console.log("merchant?"),console.log(t),t&&(l=o*.025,l=0);var h="RP",v=o+l,x=l,f=`
  ...
  `,w='RP <span class="format-float">'+o;t&&(f="",g="RP received"),showRP||(w='MYR <span class="format-float">'+o*r.chosen_country_id_.conversion,x=l*r.chosen_country_id_.conversion,v=(o+l)*r.chosen_country_id_.conversion,h="MYR"),$("cartItems").customHtml(`
                ...
                <div class="d-flex flex-column gap-1">`+i.join("")+`
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <span class=" me-4">`+h+' <span class="format-float">'+x+`</span></span>
                  </div>

                  <div class="d-flex justify-content-between align-items-center">
                    <span class="fs-4">Grand Total</span>
                    <span class=" me-4">`+h+' <span class="format-float fs-4">'+v+`</span></span>
                  </div>
                <div class="d-flex justify-content-between align-items-center pv_label d-none">
                  <span class="fs-5">`+g+`</span>
      ...
      `;t&&(E=`
        ...
        `),t&&$("cartItems").customHtml(`
                  ...
                  `),S.formatDate(),$("[add-product-id]").each((D,R)=>{var N=$(R).attr("add-product-id");function F(){m.addItemById_(N,t),t?m.components.updateMCart():m.components.updateCart(),m.components.cartItems(),m.toastChanges()}$(R)[0].onclick=F}),$("[minus-product-id]").each((D,R)=>{var N=$(R).attr("minus-product-id");function F(){m.minusItem_(N,t),t?m.components.updateMCart():m.components.updateCart(),m.components.cartItems(),m.toastChanges()}$(R)[0].onclick=F}),$("[delete-product-id]").each((D,R)=>{var N=$(R).attr("delete-product-id");function F(){m.removeItem_(N,t),t?m.components.updateMCart():m.components.updateCart(),m.components.cartItems(),m.toastChanges()}$(R)[0].onclick=F})}function I(y){$("#drp_payment").removeAttr("max"),$("#drp_payment").removeAttr("min"),$("#drp_payment").removeAttr("value"),C()}var A=document.getElementById("drp_payment");A!=null&&(A.removeEventListener("change",I),A.addEventListener("change",I)),$("[add-product-id]").each((y,T)=>{var M=$(T).attr("add-product-id");function j(){m.addItemById_(M,t),t?m.components.updateMCart():m.components.updateCart(),m.components.cartItems(),m.toastChanges()}$(T)[0].onclick=j}),$("[minus-product-id]").each((y,T)=>{var M=$(T).attr("minus-product-id");function j(){m.minusItem_(M,t),t?m.components.updateMCart():m.components.updateCart(),m.components.cartItems(),m.toastChanges()}$(T)[0].onclick=j}),$("[delete-product-id]").each((y,T)=>{var M=$(T).attr("delete-product-id");function j(){m.removeItem_(M,t),t?m.components.updateMCart():m.components.updateCart(),m.components.cartItems(),m.toastChanges()}$(T)[0].onclick=j}),$("input[name='user[payment][method]']").each((y,T)=>{$(T)[0].checked==!0&&(["register_point","merchant_point"].includes($(T).val())?($("#coupon-detail").removeClass("d-none"),C()):($("#drp_payment").removeAttr("max"),$("#drp_payment").removeAttr("min"),$("#drp_payment").removeAttr("value")))}),S.formatDate()},evalRank(e){var t="n/a",s,a=[];return _.ranks.map((n,l)=>{a.push(n)}),a.sort((n,l)=>l.retail_price-n.retail_price),s=a.filter((n,l)=>n.retail_price<=e)[0],s&&(t=s.name,$("input[name='user[rank_id]']").length>0&&$("input[name='user[rank_id]']").val(s.id)),t},updateCart(){var e,t=0,s=[],a=0;a=m.cart_.map((u,h)=>u.qty*u.retail_price).reduce((u,h)=>u+h,0),t=m.cart_.map((u,h)=>u.qty).reduce((u,h)=>u+h,0),$(".bc").html(t),m.cart_.forEach((u,h)=>{var v='<div class="font-sm">RP <span class="font-sm format-float">'+(u.retail_price*u.qty).toFixed(2)+"</span></div>";showRP||(v='<div class="font-sm">MYR <span class="font-sm format-float">'+(u.retail_price*u.qty*r.chosen_country_id_.conversion).toFixed(2)+"</span></div>"),s.push(`
          ...
          <div class="d-flex flex-column">
            ...
            <span class="format-float">`+u.retail_price+`</span>
             ...
             <a class="dropdown-item navi" href="/upgrade">
              ...
              </li>`;$(h).html(v)}),$("[minus-product-id]").each((u,h)=>{var v=$(h).attr("minus-product-id");function x(){m.minusItem_(v),m.components.updateCart(),m.toastChanges()}$(h)[0].onclick=x}),$("[delete-product-id]").each((u,h)=>{var v=$(h).attr("delete-product-id");function x(){m.removeItem_(v),m.components.updateCart(),m.toastChanges()}$(h)[0].onclick=x}),S.formatDate()},updateMCart(){var e=0,t=[],s=0;s=m.mcart_.map((a,n)=>a.qty*a.retail_price).reduce((a,n)=>a+n,0),e=m.mcart_.map((a,n)=>a.qty).reduce((a,n)=>a+n,0),$(".mbc").html(e),m.mcart_.forEach((a,n)=>{t.push(`
      ...
      `)}),$("[minus-product-id]").each((a,n)=>{var l=$(n).attr("minus-product-id");function i(){m.minusItem_(l,!0),m.components.updateMCart()}$(n)[0].onclick=i}),$("[delete-product-id]").each((a,n)=>{var l=$(n).attr("delete-product-id");function i(){m.removeItem_(l,!0),m.components.updateMCart()}$(n)[0].onclick=i}),S.formatDate()},light(){$("light").customHtml(`
      ...
      `),$("#ptitle").html(e.name);try{$("[product-id='"+e.id+"']")[0].onclick=t}catch{}})},products(){function e(a){var n="v2";return a=="Thailand"&&(n="th"),a=="Vietnam"&&(n="vn"),a=="China"&&(n="cn"),n}if(r.chosen_country_id_==null){var t=[];r.countries_.forEach((a,n)=>{t.push(`
                        ...
                        `).then(()=>{console.log("products loading?");var i=null,d="products",o=new U({onDrawFn:()=>{setTimeout(()=>{$("[product-id]").each((u,h)=>{h.onclick=()=>{a(h)}}),S.formatDate(),$(".spinner-border.loading").parent().remove(),$(".loading").removeClass("d-none")},800)},xcard:u=>{var h=u.product,v="",x="/images/placeholder.png",f=`onclick="phxApp.navigateTo('/products/`+h.id+"/"+h.name+`')"`;if($(l).attr("direct")!=null&&(f="",v='<div class="btn btn-outline-primary mt-4" product-id="'+h.id+'">Add</div>'),h.img_url!=null)try{x=h.img_url}catch{x="/images/placeholder.png"}var g='<div class=" text-primary text-center ">RP <span class="format-float">'+h.retail_price+"</span></div>";includeShippingTax&&(g='<div class="text-white text-center "><span class="format-float">'+(h.retail_price+h.base_shipping_fee)+"</span> RP</div>"),showRP||(g='<div class="font-sm fw-light text-white text-center ">MYR <span class="format-float">'+h.retail_price*r.chosen_country_id_.conversion+"</span></div>",includeShippingTax&&(g='<div class="font-sm fw-light text-secondary text-center ">MYR <span class="format-float">'+h.retail_price*r.chosen_country_id_.conversion*1.1+"</span></div>",r.chosen_country_id_.name=="Singapore"&&(g='<div class="font-sm fw-light text-secondary text-center ">MYR <span class="format-float">'+h.retail_price*r.chosen_country_id_.conversion*1.05+"</span></div>")));var w=`
                                                            ...
                                                            `;return w},data:{pageLength:12,sorts:[[2,"desc"]],additional_join_statements:[{product:"product"}],additional_search_queries:["b.is_instalment=false"],country_id:r.chosen_country_id_.id,preloads:["product"],grid_class:"col-6 col-lg-3",dom:`
      ...
      `);var s=$(t).attr("prev")!=null;console.log(s),r.api("get_reward_summary",{user_id:_.user.id,is_prev:s},null,a=>{$(".spinner-border.loading").parent().remove(),$(".loading").removeClass("d-none");var n=["sharing bonus","team bonus","matching bonus","elite leader","travel fund","repurchase bonus","drp sales level bonus","stockist register bonus","merchant sales level bonus","biz incentive bonus","matching biz incentive bonus"],l=[];n.forEach((i,d)=>{a.forEach((o,u)=>{i==o.name&&l.push(`
        ...
        `)}}),S.formatDate()}},primaryBuy(){function e(s){if(!s||!s.lines){$("#quote-summary").html("No quote yet."),$("#quote-lines").html("");return}if($("#quote-summary").html(`Filled Qty: <b>${s.filled_qty}</b> • Total Cost: <b>${s.total_cost}</b>`),s.lines.length===0){$("#quote-lines").html("");return}var a=s.lines.map(n=>`
              <tr>
                <td>${n.asset_tranche_id}</td>
      ...
      `)}}};window.commerceApp=m;const z="nph_api.damienslab.com",L="https://";let r={endpoint:L+z,Page:{createTable(e,t){var s=`
            <div class="table-responsive">
    ...
    `;$(t).append(s)}},chosen_country_id_:null,countries_:[],route_names:[{html:"landing.html",title:"Home",route:"/home",public:!0}],render(e){m.components[e]()},rowData(e){var t=e.dataSource;window.currentSelector=t.tableSelector;var s=t.table;s.row(e.row);var a=s.data()[e.index];return a},override(e){_.override(e)},updateUser(e){_.updateUser(e)},login(e){_.login(e)},logout(){_.logout()},user:null,addItem(e){var t=r.api("get_product",{id:e});t.payInstalment=!0,m.addItem_(t),m.components.updateCart(),m.components.cartItems()},filterItemsByName(e){return m.filterItemsByName(e)},hasCartItems(){return console.log("checking..."),console.log(m.hasCartItems()),m.hasCartItems()>0},merchantCheckout(e){_.merchantCheckout(e)},redeem(e){_.redeem(e)},upgrade(e){_.upgrade(e)},linkRegister(e){_.linkRegister(e)},register(e){_.register(e)},formatDate(){S.formatDate()},ping(){console.log("tell ping o")},reinit(){$(".dataTable").each((e,t)=>{if(t.offsetParent!=null){var s=window.phoenixModels.filter((a,n)=>a.tableSelector=="#"+t.id)[0];s.reload()}})},evalTitle(e){if(localStorage.getItem("default-lang")=="cn")switch(e.replace(" ","")){case"Home":e="首页";break;case"Profile":e="个人";break;case"Upgrade":e="升级";break;case"Restocks":e="朴货";break;case"Registrations":e="审核";break;case"Sales":e="业绩";break;case"Commissions":e="佣金";break;default:e=e}return e},async navigateTo(e,t){e==null&&(e=window.location.pathname);var s=e.split("/").filter((f,g)=>f!=""),a=this.route_names.filter((f,g)=>{var w=f.route.split("/").filter((k,P)=>k!="");return w[w.length-1].includes(":")?w.length==s.length:w.length==s.length&&w[w.length-1]==s[w.length-1]}),n=a.filter((f,g)=>{var w=f.route.split("/").filter((k,P)=>k!="");return w[0]==s[0]});if(this.hide(),_.restoreUser(),n.length>0){var l={};if(n.forEach((f,g)=>{f.route.split("/").forEach((w,k)=>{w.includes(":")&&(l[w.replace(":","")]=s[k-1])})}),console.info(n),!n[0].public){if(await _.restoreUser(),console.log("resting?"),_.user==null){r.navigateTo("/logout");return}}window.pageParams=l;var i="";if(t==null?i="":i=t,window.back)window.back=!1;else{var d={route:e,fn:"phxApp.navigateTo('"+e+"', '"+i+"')",params:l};window.stateObj=d,window.matchTitle=n[0].title,window.matchRoute=e,Object.keys(l).includes("title")?(history.pushState(d,evalTitle(l.title),e),$("title").html(this.evalTitle(l.title))):(history.pushState(d,this.evalTitle(n[0].title),e),$("title").html(this.evalTitle(n[0].title)))}var o=this.html("blog_nav.html"),u=this.html("footer_modals.html"),h=this.html(n[0].html),v=`
      ...
      <div class="page-content pb-0">
        `+h+`
                    ...
                    </div>`}if(typeof a=="object"){var u=[];if(a.selection!=null){var h="",v="";a.live_search!=null&&a.live_search&&(h='data-live-search="true"'),a.multiple!=null&&a.multiple&&(v="multiple"),$(a.selection).each(function(g,w){var k,P;typeof w=="object"?(k=w.name,P=w.id):(k=w,P=w),u.push('<option value="'+P+'">'+k+"</option>")}),n='<div class="'+i+`">
                      <div class="ps-1 py-2">`+o+`</div>
                      <div class="col-sm-12">
                        <div class="form-group">
                         <select `+v+" "+h+'aria-label="'+t+'" name="'+s+"["+t+`]" class="form-control selectpicker" >
                         `+u.join("")+`
                         </select>
                        </div>
                      </div>
                    ...
                    </div>`),a.checkboxes!=null){var x=[];a.checkboxes.sort(function(g,w){return g.name.localeCompare(w.name)}),$(a.checkboxes).each((g,w)=>{var k=`
                    <div class="form-check">
                      <label class="text-capitalize">
                        <input aria-label="`+t+'" class="form-check-input many_2_many" type="checkbox" name="'+s+"["+t+"]["+w.id+']"  value="true"> '+w.name+`
                        <span class="form-check-sign">
                          <span class="check"></span>
                        </span>
                      </label>
                    </div>`;x.push(k)}),n=`<div class="row">
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="row">
                          ...
                          <div class="col-2">
                            ...
                            </div>`))}if(a.hidden)if(t.includes(".")){var f=t.split(".");n='<input type="hidden" aria-label="'+t+'" name="'+s+"["+f[0]+"]["+f[1]+']"  aria-value="'+a.data+'">'}else console.log("qv",a.data),n='<input type="hidden" aria-label="'+t+'" name="'+s+"["+t+']"  aria-value="'+a.data+'">';a.required&&(n=n.replaceAll("input type","input required type"))}return n},appendInputs(e,t,s,a){$(t).each(function(n,l){var i;typeof l=="object"?i=l.label:i=l;var d="";if(d=r.generateInputs(s,i,a,l),typeof l=="object"&&!l.binary){if(l.sub!=null){var o=l.sub.moduleName,u=l.sub.link,h=l.sub.customCols;$.ajax({headers:{"phx-request":"true"},url:this.endpoint+"/svt_api/webhook?scope=gen_inputs",dataType:"json",async:!1,data:{module:o}}).done(function(v){var x=Object.keys(v);h!=null&&h.length>0&&(x=h);var f=[];$(x).each((g,w)=>{var k;typeof w=="object"?k=w.label:k=w;var P="";P=r.generateInputs(v,k,u,w),f.push(P)}),d=d+'<div class="row subform" style="display: none;"><div class="offset-1 col-sm-9">'+f.join("")+"</div></div>"}).fail(function(v){v.status==403&&_.logout(),r.notify("Not Added!",{type:"danger"})})}}$(e).append(d)})},form_new(e,t,s,a,n){console.log(t);var l=window.phoenixModels.filter((o,u)=>o.tableSelector==e)[0],i="#mySubModal";t.modalSelector!=null&&(i=t.modalSelector),s==null&&(s=l.customCols);var d='<form style="" class="with_mod" id="'+l.link+'"  module="'+l.moduleName+`">
      </form>`;$(i).find(".modal-title").html("Create  New "+l.moduleName),$(i).find(".modal-body").html(d),r.createForm({id:0,...t},l.table,s,a,n),$(i).modal("show")},createForm(e,t,s,a,n){$(".with_mod").each(function(l,i){$(i).html("");var d=$(this).attr("module"),o=$(this).attr("id");$.ajax({async:!1,headers:{"phx-request":"true"},url:phxApp.endpoint+"/svt_api/webhook?scope=gen_inputs",dataType:"json",data:{module:d}}).then((u,h,v)=>{var x=Object.keys(u);s!=null?typeof s[0]=="object"&&s[0]!==null?(console.log("has multi list,"+s.length),$(i).customHtml(`<input type="hidden" name="_csrf_token"  value="">
                            <div class="row">
